  ...
  return (
    ...
    >
      <div className="flex space-x-6 items-center">
        <CustomLink to="/" className="font-bold text-lg ml-4 flex items-center">
          <img
            src="logo.png"
            alt="logo"
      ...
      <div className="hidden sm:block">
        <ul className="flex space-x-6 justify-end pr-4">
          <li className="hover:scale-110 p-1">
            <button
              onClick={() => navigateAndScrollToSection("/", skillsSectionRef)}
            >
          ...
          <li>
            ...
            >
              {theme === "light" ? (
                ...
                <img src="/moon.png" alt="Moonpng image" className="h-6 w-6" />
              )}
            </button>
          </li>
        </ul>
